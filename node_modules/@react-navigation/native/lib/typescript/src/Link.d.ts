 ...
 */
export declare function Link<ParamList extends ReactNavigation.RootParamList>({ screen, params, action, href, className: style, ...rest }: Props<ParamList>): React.CElement<TextProps, Text>;
export { };
